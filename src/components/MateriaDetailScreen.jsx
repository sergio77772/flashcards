    ...
    <div style={{ ...styles.screen, background: "#0d0d18" }}>
      ...
      <div style={{ padding: "52px 20px 24px", background: `linear-gradient(160deg, ${color.bg}33, ${color.bg}11)`, borderBottom: `1px solid ${color.bg}22` }}>
        ...
        <div style={{ marginTop: 14, display: "flex", alignItems: "center", gap: 10 }}>
          <span style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", fontWeight: 700, letterSpacing: 1 }}>📅 EXAMEN</span>
          <input type="date" value={activeMateria.examDate || ""} onChange={(e) => setMateriaDeadline(e.target.value)}
            style={{ background: "transparent", border: "none", fontSize: 14, fontWeight: 700, color: activeMateria.examDate ? "#f0f0ff" : "rgba(255,255,255,0.3)", outline: "none", flex: 1 }} />
        </div>
      </div>
